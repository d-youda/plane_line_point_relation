...
from action_function import three_point_make_plane,two_plane_angles,plane_and_line_angle,two_points_distance,point_and_plane_distance,point_and_mid_point_plane,two_points_one_plane, one_point_two_planes,line_and_line_angle
def main():
    root = tk.Tk()
    ...
    def two_point_one_plane():
        two_points_one_plane(root,ax,canvas)
    def one_point_two_plane():
        one_point_two_planes(root,ax,canvas)
        #라인
    def plane_and_line_event():
        plane_and_line_angle(root,ax,canvas)
    def line_and_line_event():
        line_and_line_angle(root,ax,canvas)
        #점
    def two_point_event():
    ...
    def show_plane_button():
        #평면과 관련된 연산들
        three_point_button = tk.Button(root, text="세 점을 지나는 평면 그리기", command=three_point_event)
        ...
        one_plane_two_point = tk.Button(root, text="두 점을 지나고, 한 평면에 수직인 평면 그리기", command=two_point_one_plane)
        one_plane_two_point.pack(pady=15)
        two_plane_one_point = tk.Button(root,text="한점을 지나고, 두 평면과 수직인 평면 그리기",command=one_point_two_plane)
        two_plane_one_point.pack(pady=15)
    ...
    def show_line_button():
        ...
        two_line_angle = tk.Button(root, text="라인과 라인 간 각도 구하기",command=line_and_line_event)
    ...
    button4 = tk.Button(root, text='Cancel',command=stop_exeuation,width=20)
